...
public class OccurrenceFunctionFunction extends AbstractInvariant implements
    ...
    // Tìm số xuất hiện của giá trị f.getValue() bên trong mảng các lstF[i].getValue()
    // Do biến function thì luôn biến đổi (khi biến VarIntLS tương ứng của nó thay đổi)
    // vì thế : số lần xuất hiện cũng sẽ thay đổi tương ứng !!!
