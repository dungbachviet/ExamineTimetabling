...
public class ElementTmp extends AbstractInvariant implements IFunction {
    ...
    public ElementTmp(int[] c, IFunction index) {
        ...
        _f1 = index;
        // Mã nguồn này họ đang làm tổng quát cho trường hợp mảng 2 chiều, tức phải có 
        // 2 index để trỏ tới 1 phần tử (index hàng và index cột). Nhưng do ở đây chỉ
        // là mảng 1 chiều nên index thứ 2 phải cho bằng 0 (nghĩa là chỉ là mảng 1 chiều)
